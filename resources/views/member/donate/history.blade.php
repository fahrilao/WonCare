                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="bg-info bg-opacity-10 rounded p-3">
                                            <i class="ti tabler-cash text-info" style="font-size: 2rem;"></i>
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        @foreach ($donations as $donation)
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="small text-muted">{{ $donation->created_at->format('H:i') }}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        @if ($donation->campaign?->primaryImage)
                                                            <img src="{{ asset('storage/' . $donation->campaign->primaryImage->image_url) }}"
                                                                alt="{{ $donation->campaign->title }}" class="rounded me-2"
                                                    ...
                                                    @if ($donation->payment_provider)
                                                        <div class="d-flex align-items-center">
                                                            @if ($donation->payment_provider === 'midtrans')
                                                                <i class="ti tabler-building-bank text-primary me-2"></i>
                                                    ...
                                                    <div class="btn-group btn-group-sm">
                                                        ...
                                                        @if ($donation->status === 'pending' && $donation->snap_redirect_url)
                                                            <a href="{{ $donation->snap_redirect_url }}"
                                                                class="btn btn-outline-success" title="Continue Payment">
