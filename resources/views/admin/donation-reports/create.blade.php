...
@section('title', __('donation_reports.create_donation_report'))
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">{{ __('donation_reports.create_donation_report') }}</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.donation-reports.store') }}" method="POST"
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-select @error('donation_campaign_id') is-invalid @enderror"
                                        ...
                                        @foreach ($campaigns as $campaign)
                                            <option value="{{ $campaign->id }}"
                                                {{ old('donation_campaign_id', $selectedCampaign?->id) == $campaign->id ? 'selected' : '' }}>
                                                {{ $campaign->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('distributed_amount') }}" min="0" step="0.01" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('distribution_date') }}" max="{{ date('Y-m-d') }}" required>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('beneficiaries') is-invalid @enderror" id="beneficiaries" name="beneficiaries"
                                        rows="3">{{ old('beneficiaries') }}</textarea>
                                    @error('beneficiaries')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-12 mb-3">
                                    <label for="evidence_file"
                                        class="form-label">{{ __('donation_reports.evidence_file') }}</label>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="{{ route('admin.donation-reports.index') }}" class="btn btn-secondary">
                                            {{ __('common.cancel') }}
                                        </a>
                                        <button type="submit" class="btn btn-primary">
                                            {{ __('donation_reports.create_report') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
