                ...
                <div class="card">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-header">
                            ...
                            <small class="text-secondary">{{ __('classes.list_description') }}</small>
                        </h5>
                        <div class="pe-5">
        ...
        $(document).ready(function() {
            ...
            $('#classes-table').DataTable({
                ...
                language: {
                    ...
                    zeroRecords: "{{ __('datatable.classes.zeroRecords') }}",
                    emptyTable: "{{ __('datatable.classes.emptyTable') }}",
                    paginate: {
