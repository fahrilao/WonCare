...
@section('title', __('payment_gateways.edit_title'))
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>{{ __('payment_gateways.edit_title') }}</h4>
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.payment-gateways.show', $paymentGateway->id) }}"
                        ...
                        <form action="{{ route('admin.payment-gateways.update', $paymentGateway->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name', $paymentGateway->name) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if($paymentGateway->api_key)
                                        <div class="mb-2">
                                            <small class="text-muted">{{ __('payment_gateways.masked_key') }}: {{ $paymentGateway->getMaskedApiKey() }}</small>
                                        </div>
                                    @endif
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if($paymentGateway->secret_key)
                                        <div class="mb-2">
                                            <small class="text-muted">{{ __('payment_gateways.masked_key') }}: {{ $paymentGateway->getMaskedSecretKey() }}</small>
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="is_sandbox" name="is_sandbox" 
                                                       value="1" {{ old('is_sandbox', $paymentGateway->is_sandbox) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                                    ...
                                    placeholder="{{ __('payment_gateways.description_placeholder') }}">{{ old('description', $paymentGateway->description) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('additional_config') is-invalid @enderror" 
                                    ...
                                    placeholder='{"key": "value"}'>{{ old('additional_config', $paymentGateway->additional_config ? json_encode($paymentGateway->additional_config, JSON_PRETTY_PRINT) : '') }}</textarea>
