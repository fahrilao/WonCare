...
@section('title', __('community.volunteer_events.create_title'))
            ...
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>{{ __('community.volunteer_events.create_title') }}</h4>
                        <a href="{{ route('admin.community.volunteer-events.index') }}"
                            class="btn btn-secondary btn-sm">{{ __('common.back_to_list') }}</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.community.volunteer-events.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                <small
                                    class="form-text text-muted">{{ __('community.volunteer_events.fields.is_online') }}:
                                    {{ __('common.yes') }} / {{ __('common.no_value') }}</small>
                            </div>
