...
@section('title', __('events.edit_title'))
                        ...
                        <form action="{{ route('admin.events.update', $event) }}" method="POST"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select{{ $errors->has('type') ? ' is-invalid' : '' }}"
                                        ...
                                        <option value="offline"
                                            {{ old('type', $event->type) === 'offline' ? 'selected' : '' }}>
                                            {{ __('events.types.offline') }}</option>
                                        <option value="online"
                                            {{ old('type', $event->type) === 'online' ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('reminder_hours_before', $event->reminder_hours_before) }}"
                                        min="1">
                            ...
                            <div class="mb-3">
                                ...
                                @if ($event->banner_image)
                                    <div class="mb-2">
                                        <img src="{{ $event->banner_url }}" alt="Current Banner" class="img-thumbnail"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="require_rsvp"
                                            ...
                                            {{ old('require_rsvp', $event->require_rsvp) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="send_reminder"
                                            ...
                                            {{ old('send_reminder', $event->send_reminder) ? 'checked' : '' }}>
                                        <label class="form-check-label"
